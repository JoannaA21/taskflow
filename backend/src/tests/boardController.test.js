...
describe("Board Controller", () => {
  ...
  it("should return 500 if there is an error in creating a new board", async () => {
    Board.create.mockRejectedValue(new Error("Failed to create a new board.")); //mock the create function to throw an error, simulating a database error. Fake database error
    await createBoard(req, res); //call the createBoard function with the mocked req and res
